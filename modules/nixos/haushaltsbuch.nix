...
{config, ...}: let
  # Tag 85cdef7 (App-Repo main, 2026-08-05).
  haushaltsbuchImage = "ghcr.io/ec0m3x/haushaltsbuch@sha256:b6d62b4ff6739dc02a12732a2173c8ae801eec8ab39b8a00d374ee6eab698a5a";
  ghcrLogin = {
    registry = "ghcr.io";
    username = "ec0m3x";
