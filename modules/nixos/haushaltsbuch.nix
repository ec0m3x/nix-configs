...
{config, ...}: let
  # Tag e34f6c3 (App-Repo main, 2026-08-05).
  haushaltsbuchImage = "ghcr.io/ec0m3x/haushaltsbuch@sha256:8186a152032464b885039dbb9b89aa1edd5fdaf9eb1effe80e7b4927e2b9cf45";
  ghcrLogin = {
    registry = "ghcr.io";
    username = "ec0m3x";
