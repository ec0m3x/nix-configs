...
{config, ...}: let
  # Tag b8ad8ad (App-Repo main, 2026-08-05).
  haushaltsbuchImage = "ghcr.io/ec0m3x/haushaltsbuch@sha256:29310eafb07087df75fcaa7352ade4e0eb7d6c5cb1496a23191877c9dc3547da";
  ghcrLogin = {
    registry = "ghcr.io";
    username = "ec0m3x";
