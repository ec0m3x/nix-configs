...
{config, ...}: let
  # Tag eb3b6e2 (App-Repo main, 2026-08-05).
  haushaltsbuchImage = "ghcr.io/ec0m3x/haushaltsbuch@sha256:c29795b881039bd2649775c0b4756c11eb37dc4f0737a8b3cfd4c9239df6540f";
  ghcrLogin = {
    registry = "ghcr.io";
    username = "ec0m3x";
